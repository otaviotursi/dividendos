...
def save_trades_to_csv(df, min_dy, days_offset, allow_overlap):
    """
    ...
    Args:
        ...
        days_offset: Dias de intervalo para compra/venda
    ...
    try:
        ...
        output_file = f"data_cache/trades_dy{min_dy}_dias{days_offset}_{overlap_str}.csv"
